...
- Modular JS architecture (`import`/`export`) and building real-world projects
...
| 04 | Data Types | 🟢 Beginner | [Open lesson](04-data-types.md) |
| 05 | Operators | 🟢 Beginner | [Open lesson](05-operators.md) |
| 06 | Conditionals (`if`, `else`, `switch`) | 🟢 Beginner | [Open lesson](06-conditionals.md) |
| 07 | Loops (`for`, `while`) | 🟢 Beginner | [Open lesson](07-loops.md) |
| 08 | Functions | 🟢 Beginner | [Open lesson](08-functions.md) |
| 09 | Arrays & Basic Methods | 🟡 Intermediate | [Open lesson](09-arrays.md) |
| 10 | Objects | 🟡 Intermediate | [Open lesson](10-objects.md) |
| 11 | Scope, Hoisting & Temporal Dead Zone | 🟡 Intermediate | [Open lesson](11-scope-and-hoisting.md) |
| 12 | Modern ES6+ Features (Destructuring, Spread/Rest) | 🟡 Intermediate | [Open lesson](12-es6-features.md) |
...
`01–08 Core Fundamentals` → `09–13 ES6 & Data Manipulation` → `14–16 Async JS & APIs` → `17–18 Prototypes & OOP` → `19–21 DOM & Storage` → `22–24 Modules & Final Projects`
